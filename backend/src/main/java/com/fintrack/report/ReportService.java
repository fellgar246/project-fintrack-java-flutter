...
public class ReportService {
  ...
  public SummaryResponse summary(UUID userId, String yearMonth) {
    ...
    List<SummaryAccountRow> rows =
        reportRepository.findSummaryForMonth(userId, monthStart, monthEnd);
  ...
  public List<ByCategoryResponse> byCategory(UUID userId, String yearMonth, String kind) {
    ...
    List<ByCategoryRow> rows =
        reportRepository.findByCategoryForMonth(userId, categoryKind.name(), monthStart, monthEnd);
