...
public class ReportController {
    ...
    @GetMapping("/summary")
    @Operation(description = "Monthly income/expense summary with per-account breakdown. Transfers excluded (RB-03).")
    ...
    @GetMapping("/trend")
    @Operation(description = "Monthly income/expense trend ending in the current month. Empty months included.")
