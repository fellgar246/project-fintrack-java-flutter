...
public class CategoryService {
    ...
    private static final String DUPLICATE_NAME_MESSAGE = "A category with that name already exists for this kind";
    ...
    private void assertUniqueName(UUID userId, String name, CategoryKind kind, UUID excludeId) {
        boolean duplicate = excludeId == null
            ...
            : categoryRepository.existsByUserIdAndNameIgnoreCaseAndKindAndIdNot(userId, name, kind, excludeId);
